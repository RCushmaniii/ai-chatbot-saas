...
export function RagbotLandingPage() {
	...
	const demoAnswer =
		"Based on HR_Policy.pdf §3.2, full-time employees receive 15 days of PTO annually, accruing at 1.25 days per month.";
	...
	return (
		<div className="relative min-h-screen bg-black text-white overflow-x-hidden">
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						<div>
							...
							<p className="text-xl text-white/70 mb-4 leading-relaxed max-w-xl">
								Deploy an AI assistant trained on your knowledge base. Accurate
								answers. Source transparency. Enterprise-grade security.
							</p>

							<p className="text-sm text-white/50 mb-10 max-w-xl">
								Permissions-aware RAG for customer support, sales enablement,
								and internal teams.
							</p>
							...
							<div className="border-t border-white/10 pt-8">
								<p className="text-xs text-white/40 mb-4 tracking-widest">
									TRUSTED BY
								</p>
					...
					<div className="grid md:grid-cols-4 gap-8 items-center">
						<div className="md:col-span-2">
							<p className="text-2xl font-bold leading-tight">
								Most teams waste hours searching docs—or answer customers
								inconsistently.
							</p>
						</div>
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-20">
						...
						<p className="text-xl text-white/60">
							Enterprise-ready RAG, out of the box
						</p>
					</div>
								...
								<div>
									...
									<ul className="space-y-4 text-white/70">
										...
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Instant answers from help docs, policies, and FAQs
											</span>
										</li>
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Escalate complex issues to agents with full context
											</span>
										</li>
									</ul>
								</div>
								...
								<div>
									...
									<ul className="space-y-4 text-white/70">
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Reps find product specs, pricing, case studies instantly
											</span>
										</li>
										<li className="flex items-start gap-3">
											<CheckIcon />
										...
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Reduce time-to-close with accurate, cited answers
											</span>
										</li>
									</ul>
								</div>
								...
								<div>
									...
									<ul className="space-y-4 text-white/70">
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Answer PTO, benefits, and policy questions 24/7
											</span>
										</li>
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Onboard new hires faster with self-serve knowledge
											</span>
										</li>
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Maintain compliance with cited, auditable answers
											</span>
										</li>
									</ul>
								</div>
								...
								<div>
									...
									<ul className="space-y-4 text-white/70">
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Resolve password resets, VPN issues, app access
												instantly
											</span>
										</li>
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Reduce helpdesk load by 70%+ with self-service
											</span>
										</li>
										<li className="flex items-start gap-3">
											<CheckIcon />
											<span>
												Create tickets automatically for complex issues
											</span>
										</li>
									</ul>
								</div>
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid md:grid-cols-3 gap-8">
						{[
							{
								quote:
									"Ragbot cut our support tickets by 65% in the first month. Game changer.",
								name: "Sarah Chen",
								title: "VP Support",
								company: "TechCorp",
							...
							{
								quote:
									"Our sales team finds answers in seconds instead of searching Notion for hours.",
								name: "Marcus Johnson",
								title: "Head of Sales",
								company: "GrowthCo",
							...
							{
								quote:
									"The citation feature builds trust. Customers see we're not making things up.",
								name: "Priya Patel",
								title: "CTO",
								company: "Fintech Inc",
								metric: "89% accuracy",
							...
							<div
								key={i}
								className="bg-white/[0.02] border border-white/10 rounded-xl p-8 hover:border-[#FF5A1F]/30 transition-all"
							>
								...
								<div className="border-t border-white/10 pt-6">
									...
									<div className="text-sm text-[#FF5A1F] mt-2 font-mono">
										{testimonial.metric}
									</div>
								</div>
							</div>
				...
				<div className="max-w-5xl mx-auto">
					...
					<div className="flex flex-wrap justify-center gap-4">
						{["SOC 2", "GDPR", "HIPAA", "ISO 27001"].map((badge, i) => (
							<div
								key={i}
								className="px-6 py-3 border border-white/20 rounded-lg text-sm font-medium text-white/60"
							>
								{badge}
							</div>
						))}
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<div className="inline-flex items-center gap-4 bg-white/5 border border-white/10 rounded-lg p-1">
							...
							>
								Annual{" "}
								<span className="text-[#FF5A1F] text-xs ml-1">Save 20%</span>
							</button>
						</div>
					</div>
			...
			<section
				id="faq"
				className="py-32 px-6 bg-gradient-to-b from-white/[0.02] to-transparent"
			>
			...
			<section className="py-32 px-6 relative overflow-hidden">
				...
				<div className="max-w-4xl mx-auto text-center relative z-10">
					<h2 className="text-6xl font-bold mb-6">Ready to deploy?</h2>
			...
			<footer className="border-t border-white/10 py-16 px-6">
				<div className="max-w-7xl mx-auto">
					<div className="grid md:grid-cols-5 gap-12 mb-12">
						{/* Product */}
						<div>
							<div className="text-sm font-bold mb-4 tracking-widest text-white/50">
								PRODUCT
							</div>
						...
						<div>
							...
							<div className="flex gap-4">
								<a
									href="#"
									className="w-10 h-10 border border-white/20 rounded-lg flex items-center justify-center hover:border-[#FF5A1F] hover:bg-[#FF5A1F]/10 transition-all"
								>
