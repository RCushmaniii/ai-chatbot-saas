...
export default function DemoPage() {
	...
	return (
		<div className="min-h-screen bg-ink flex flex-col">
			...
			{/* Video — centered, auto-plays once */}
			<div className="flex-1 flex flex-col items-center justify-center px-6 pb-8">
				<h1 className="text-white font-display font-bold text-2xl sm:text-3xl text-center mb-2">
					{isEs ? "Converso en acción" : "Converso in action"}
				</h1>
				<p className="text-white/50 text-sm text-center mb-8 max-w-lg">
					{isEs
